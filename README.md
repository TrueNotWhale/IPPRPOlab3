...
![alt text](https://github.com/TrueNotWhale/IPPRPOlab3/actions/workflows/gradle.yml/badge.svg)
...
Сначала файлы группируются по размеру.

Затем, только для групп файлов с одинаковым размером, вычисляются и сравниваются хэш-суммы.
